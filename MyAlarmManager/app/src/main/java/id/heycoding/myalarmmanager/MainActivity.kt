package id.heycoding.myalarmmanager
...
import id.heycoding.myalarmmanager.databinding.ActivityMainBinding
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_set_once_alarm -> {
                ...
                alarmReceiver.setOnTimeAlarm(this, AlarmReceiver.TYPE_ONE_TIME, onceDate, onceTime, onceMessage)
            }
